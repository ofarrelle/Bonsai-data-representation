...
for ind_dim, num_dims in enumerate(num_dims_list):
    ...
    if num_dims == 2:
        ...
        ax3[2].scatter(umap_projected[args.n_pcs_umap][0, :], umap_projected[args.n_pcs_umap][1, :],
                       c=colors)
        ax3[2].set_title("UMAP-embedded data")
        ax3[3].scatter(phate_projected[args.n_pcs_phate][0, :], phate_projected[args.n_pcs_phate][1, :],
                       c=colors)
        ax3[3].set_title("PHATE-embedded data")
        plt.tight_layout()
